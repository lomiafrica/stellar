...
import type { PayoutStatus, StellarSettlementRecord } from "../ledger/store.js";
...
export type CreateStellarPayoutInput = {
  ...
  amount_usdc?: string;
  phone?: string;
  /** Real Bridge transfer id from Nest. When set, the lab reuses it instead of creating a mock transfer. */
